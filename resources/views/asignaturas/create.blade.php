<x-layouts.app :title="__('Crear Asignatura')">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Creación de
                        Asignatura</span>
                </div>
            </li>
        </ol>
    ...
    <h3
        class="text-center font-bold m-auto text-xl text-gray-700 text-wrap justify-center items-center p-4 flex-1 bg-gray-100 rounded w-full uppercase py-2">
        Prof: {{ auth()->user()->name }}
    </h3>
    ...
    <form method="POST" action="{{ route('asignaturas.store') }}" class="w-full bg-red-50">
        ...
        <div class="flex gap-4 mx-2 bg-gray-100">
            <button type="submit"
