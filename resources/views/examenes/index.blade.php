                ...
                <div class="card mx-auto w-full md:w-full text-center">
                    <div class="card-header bg-primary text-white">
                        <div class="card-title flex justify-between items-center">
                            ...
                            <a href="{{route('examenes.create')}}" class="text-white cursor-pointer" title="{{ __('add examen') }}">
                        ...
                        <table id="examen" class="table table-hover text-[14px]" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($examenes as $examen)
                                    <tr>
                                        <td width="10%">{{ $examen->id }}</td>
                                        <td width="70%">{{ $examen->answer }}</td>
                                        <td width="10%">
                                            @if ($examen->is_true)
                                                Verdadero
                                            @else
                                        ...
                                        <td width="100%" class="flex flex-col gap-8 items-center flex-wrap">
                                            <a href="{{ route('modificar', $examen) }}" class="text-green-600"
