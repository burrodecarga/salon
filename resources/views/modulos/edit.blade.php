<x-layouts.app :title="__('modificar módulo')">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li aria-current="page">
            <div class="flex items-center">
              ...
              <a href="#" class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">{{$asignatura->name}}</a>
            </div>
          </li>
          <li aria-current="page">
            <div class="flex items-center">
          ...
          <li aria-current="page">
            <div class="flex items-center">
              ...
              <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Modificar Módulo {{$modulo->name}}</span>
            </div>
          </li>
        </ol>
      </nav>
