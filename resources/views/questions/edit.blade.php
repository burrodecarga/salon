<x-layouts.app :title="__('Crear lección a módulo')">
       ...
       @include('nav.modulos')
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span     class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Modificar Lección</span>
          </div>
        </li>
    ...
    <div class="w-full mx-auto bg-gray-300 rounded shadow-lg">
        <div class="w-full p-6 mx-auto my-10">
            ...
            <hr>
            <form action="{{ route('lessons.update',[$asignatura,$modulo,$lesson]) }}" method="POST">
                @method('PUT')
